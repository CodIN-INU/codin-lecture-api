...
public class LectureDetailResponseDto extends LecturePreviewResponseDto {
    ...
    private String evaluation; //todo로 변경 가능
...
//    private Emotion emotion;
    ...
    public LectureDetailResponseDto(String id, String title, Type type, int grade, int credit, List<String> tags, Boolean liked, Department department, Department college, String evaluation, String lectureType, List<Schedule> schedule, String preCourse) {
        super(id, title, type, grade, credit, tags, liked);
