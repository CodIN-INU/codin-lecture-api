...
public class LectureDetailResponseDto extends LecturePreviewResponseDto {
    ...
    public LectureDetailResponseDto(String id, String title, String professor, Type type, int grade, int credit, List<String> tags, Boolean liked, Department department, Department college, String evaluation, String lectureType, List<Schedule> schedule, String preCourse, Emotion emotion) {
        super(id, title, professor, type, grade, credit, tags, liked);
