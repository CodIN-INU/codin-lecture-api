...
public enum LikeErrorCode implements GlobalErrorCode {
    ...
    LIKE_RESPONSE_NULL(HttpStatus.INTERNAL_SERVER_ERROR, "Response된 Data가 null 입니다.", Level.ERROR),
    LIKE_UNEXPECTED_MESSAGE(HttpStatus.INTERNAL_SERVER_ERROR, "예상치 못한 좋아요 메세지 입니다.", Level.ERROR);
